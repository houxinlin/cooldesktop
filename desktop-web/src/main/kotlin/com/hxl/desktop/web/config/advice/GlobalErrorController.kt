...
import com.hxl.desktop.common.exceptions.WebArgException
...
class GlobalErrorController {
    ...
    @ExceptionHandler(WebArgException::class)
    fun handlerWebArgException(webArgException: WebArgException){
